...
<head>
    ...
    <!--<style>
      ...
      <script type="text/javascript" src="script_color.js"></script>
</head>
...
<header role="banner" style="background-color: black;">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-light">
        ...
        <div class="px-4 py-2 my-2 text-center border-bottom">
          <h1 class="display-5 fw-bold">Color de la Prenda</h1>
          <div class="col-lg-6 mx-auto">
            ...
            <p class="lead mb-0">Disculpa si la precisición de nuestra IA no es perfecta. Recuerda que sigue en desarrollo :)</p>     
          </div>
        </div>
      <div>
        <center>
      ...
      <br>
      <script src="script_color.js" type="module"></script>
