...
$consulta = "SELECT * FROM Tbl_Prenda a INNER JOIN Tbl_Persona b ON a.idPersona = b.id WHERE a.Tipo = 'Abrigo'";
...
<html lang="es">
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1>Tus Abrigos</h1>
              <p class="lead">A continuacion verás los abrigos que has subido a la nube.</p>
            </div>          
          </div>
        </div>
      </div>
    ...
    <section class="site-section bg-light ">
      ...
      <center><a href ="filtrosabrigos.php">
