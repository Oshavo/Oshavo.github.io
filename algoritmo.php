...
<html lang="es">
  ...
  <header role="banner" style="background-color: black;">
   ...
   <section class="hero__section">
      ...
      <label for="foto">Elige el tipo de prenda que deseas vestir</label>
      </center>
      <div class="row">
      <center>
      <a href="algoritmoSup.php"><button class="btn btn-primary">Prenda Superior</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="algoritmoInf.php"><button class="btn btn-primary">Prenda Inferior</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="algoritmoVes.php"><button class="btn btn-primary">Vestido</button></a>
      </center>  
    </div> 
    ...
    <script>
      ...
      function mostrarDatos() {
        ...
        form.method = 'post';
        form.action = 'mostrar_random.php';
