    ...
    <div class="container">
      <div class="main-body">
        <div class="row gutters-sm">
          ...
          <div class="col-md-8">
            <div class="card mb-3">
            <form action="editardatos.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="text" class="form-control" name="Nombre" value="<?php echo $nombrecom?>">
                    </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="text" class="form-control" name="Usuario" value="<?php echo $nusuario?>">
                    </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="text" class="form-control" name="Email" value="<?php echo $correo?>">
                    </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <hr>                    
                    <input class="btn btn-outline-primary" type="file" name="Foto">Cambiar foto de perfil</input>
                    <hr>
                    <div class="row">
