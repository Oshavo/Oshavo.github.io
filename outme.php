...
$consulta = "SELECT * FROM Tbl_Prenda a INNER JOIN Tbl_Persona b ON a.idPersona = b.id WHERE b.Usuario = '$user'"; // Solo selecciona las prendas del usuario actual

$resultado = $conn->query($consulta);
$prendas = array(); // arreglo para almacenar las prendas del usuario
            ...
            <form action="guardarconjunto.php" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="cold-md-4 form-group">
                  ...
                  <label for="foto">Elige una de las maneras de obtener tu Outfit</label>  
                </div>
              </div>
            </form>
