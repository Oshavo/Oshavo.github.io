...
$consulta = "SELECT * FROM Tbl_Prenda a INNER JOIN Tbl_Persona b ON a.idPersona = b.id WHERE a.Tipo = 'Playera'";
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1>Tus Playeras</h1>
              <p class="lead">A continuacion verás las playeras que has subido a la nube.</p>
            </div>          
          </div>
        </div>
      </div>
