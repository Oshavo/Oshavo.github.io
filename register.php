        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav absolute-right">
              <li class="nav-item">
                <a href="login.php" class="nav-link">Acceso</a>
              </li>
              <li class="nav-item">
                ...
                <h2>Registrarse</h2>
                  <form action="registro.php" method="POST">
                    <div class="field input">
                        <label>Usuario</label>
                        <input type="text" placeholder="Ingresa un Usuario" name="Usuario">
                    </div>
                    <div class="field input">
                        <label>Correo</label>
                        <input type="text" placeholder="Ingresa un Correo" name="Email">
                    </div>
                    <div class="field input">
                        <label>Contraseña</label>
                        <input type="password" placeholder="Ingresa una Contraseña" name="Contraseña">
                    </div>
                    <div class="field input">
                        <label>Repetir Contraseña</label>
                        <input type="password" placeholder="Repite la Contraseña" name="Rcontraseña">
                    </div>                                     
